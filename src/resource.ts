...
import { IDocumentWaste } from "./types/document/interface";
import { DocumentTemplateType } from "./types/documentTemplate/interface";
...
export const DOCUMENT_WASTE_TREATMENT_18 = "Ração Animal";
export const DOCUMENT_WASTE_TREATMENT = (value: DocumentWasteTreatment) => {
  switch (value) {
    ...
    case DocumentWasteTreatment.ANIMAL_FEED:
      return DOCUMENT_WASTE_TREATMENT_18;
    default:
...
export const DOCUMENT_WASTE_ORIGIN_POINT_14 = "Almoxarifado";
export const DOCUMENT_WASTE_ORIGIN_POINT = (
  ...
  switch (value) {
    ...
    case DocumentWasteOriginPoint.WAREHOUSE:
      return DOCUMENT_WASTE_ORIGIN_POINT_14;
    default:
...
export const DOCUMENT_WASTE_CONTAINMENT_ACCIDENT_4 = "Não especificado";
export const DOCUMENT_WASTE_CONTAINMENT_ACCIDENT = (
  ...
  switch (value) {
    ...
    case IDocumentWasteContainmentAccident.UNSPECIFIED:
      return DOCUMENT_WASTE_CONTAINMENT_ACCIDENT_4;
    default:
...
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_16 = "Refeitório / Restaurante";
...
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_36 = "Confeitaria";
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_37 = "Podologia";
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_38 = "Radiologia";
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_39 = "Ambulatório";
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_40 = "Almoxarifado";
export const DOCUMENT_HEALTH_WASTE_ORIGIN_POINT = (
  ...
  switch (value) {
    ...
    case DocumentHealthWasteOriginPoint.BAKERY:
      return DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_36;
    case DocumentHealthWasteOriginPoint.PODIATRY:
      return DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_37;
    case DocumentHealthWasteOriginPoint.RADIOLOGY:
      return DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_38;
    case DocumentHealthWasteOriginPoint.AMBULATORY:
      return DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_39;
    case DocumentHealthWasteOriginPoint.WAREHOUSE:
      return DOCUMENT_HEALTH_WASTE_ORIGIN_POINT_40;
    default:
...
export const DOCUMENT_HEALTH_ADDITIONS_SECURITY_VACCINES_99 = "OUTRAS";
export const DOCUMENT_HEALTH_ADDITIONS_SECURITY_VACCINES = (
  ...
  switch (value) {
    ...
    case DocumentHealthAdditionsSecurityVaccines.OTHER:
      return DOCUMENT_HEALTH_ADDITIONS_SECURITY_VACCINES_99;
    default:
      return `[DOCUMENT_HEALTH_ADDITIONS_SECURITY_VACCINES_${value}]`;
  }
};

export const DOCUMENT_HEALTH_ADDITIONS_SANITIZATION_ILLUMINATION_NATURAL =
  "Iluminação Natural";
export const DOCUMENT_HEALTH_ADDITIONS_SANITIZATION_ILLUMINATION_ARTIFICIAL =
  "Iluminação Artificial";
export const DOCUMENT_HEALTH_ADDITIONS_SANITIZATION_ILLUMINATION = (
  value: DocumentHealthAdditionsSanitizationVentilation
) => {
  switch (value) {
    case DocumentHealthAdditionsSanitizationVentilation.NATURAL:
      return DOCUMENT_HEALTH_ADDITIONS_SANITIZATION_ILLUMINATION_NATURAL;
    case DocumentHealthAdditionsSanitizationVentilation.ARTIFICIAL:
      return DOCUMENT_HEALTH_ADDITIONS_SANITIZATION_ILLUMINATION_NATURAL;
    default:
      return `[DOCUMENT_HEALTH_ADDITIONS_SANITIZATION_VENTILATION_${value}]`;
