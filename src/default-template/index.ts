    ...
    content: [
            ...
            stack: [
              ...
              },
              {
                text: [
                  ...
                  "\nDE RESÍDUOS SÓLIDOS (INDIVIDUAL)",
                  " PGRS",
                ],
                style: ["bold", "font-2xl", "center"],
                margin: [10, 150],
              },
              {
                layout: "noBorders",
        ...
        stack: [
          ...
          },
          {
            ...
            ol: [
              ...
              [
                { text: "DADOS DO EMPREENDIMENTO", marginTop: 10 },
                {
                  style: ["not-bold", "font-base"],
                  ol: ["CARACTERIZAÇÃO DO EMPREENDIMENTO"],
                  separator: ["2.", "   "],
                  marginLeft: -15,
                  marginTop: 5,
                },
              ],
              [{ text: "EQUIPE TÉCNICA", marginTop: 10 }],
              [
                {
                ...
                },
                {
                  ...
                  ol: [
                    ...
                    "LEVANTAMENTO QUALI E QUANTITATIVO DOS RESÍDUOS GERADOS",
                  ],
                  separator: ["4.", "   "],
                  marginLeft: -15,
                  marginTop: 5,
              ...
              [
                ...
                },
                {
                  style: ["not-bold", "font-base"],
                  ol: [
                    "LOGÍSTICA DO GERENCIAMENTO PROPOSTO",
                    "COLETA INTERNA",
                    "EDUCAÇÃO AMBIENTAL",
                    [
                      "AÇÕES PREVENTIVAS, CORRETIVAS E DE CONTROLE NO MANEJO DE RESÍDUOS",
                      {
                        separator: ["5.4.", "   "],
                        ol: ["Avaliação e Monitoramento do PGRS"],
                        marginLeft: -15,
                      },
                    ],
                    "TREINAMENTO E SENSIBILIZAÇÃO",
                    "PROGNÓSTICO DOS IMPACTOS SÓCIO-ECONÔMICOS E AMBIENTAIS DO PLANO PROPOSTO",
                    "DESTINAÇAO FINAL",
      ...
      },
      {
        ...
        stack: [
          ...
          {
            text: "A atual exigência dos órgãos ambientais fiscalizadores no sentido de se fazer cumprir a Lei nº 12.305/10 e a Resolução CONAMA 313/02 e definitivamente desmistificar a omissão do poder público, sensibiliza todos aqueles que, em suas atividades, lidam com a problemática de destinação final dos resíduos sólidos e buscam de alguma maneira um controle e gerenciamento mais efetivo dos mesmos.",
            marginTop: 15,
          },
          {
            text: [
          ...
          {
            text: [
              "O escopo do presente trabalho é a elaboração do Plano de Gerenciamento de Resíduos Sólidos da empresa ",
              { text: document.company?.name ?? FIELD_EMPTY, style: ["bold"] },
          ...
          },
          {
            text: [
              {
                text: "Fase II - Plano de gerenciamento de resíduos e Apoio à implementação do PGRS:",
                style: ["bold"],
              },
              " esquematiza os passos necessários para gerenciar com eficiência os resíduos sólidos produzidos e fornece treinamento e apoio ao grupo de multiplicadores do PGRS.",
            ],
            marginTop: 15,
          },
          {
          ...
          "A documentação do plano de gerenciamento compreende este relatório, os procedimentos para implementação para a gestão de resíduos sólidos.",
        ],
      },
      {
        pageBreak: "before",
            ...
            table: {
              ...
              body: [
                ...
                [
                  {
                    text: [
                      { text: "Administrativo: ", style: ["bold"] },
                      {
                        text: document.company?.administrativeEmployeesCount
                          ? `${document.company?.administrativeEmployeesCount} pessoas`
                          : FIELD_EMPTY,
                      },
                    ],
                    border: borderOptions.noBorder,
                ...
                [
                  {
                    text: [
                      { text: "Operação/Produção: ", style: ["bold"] },
                      {
                        text: document.company?.productionEmployeesCount
                          ? `${document.company?.productionEmployeesCount} pessoas`
                          : FIELD_EMPTY,
                      },
                    ],
                    border: borderOptions.bottomOnly,
